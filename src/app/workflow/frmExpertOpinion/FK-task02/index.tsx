...
import { FrmExpertOpinionResponse, FrmExpertOpinionInvestigationProcessResponse, FrmExpertOpinionActionPointResponse, FrmExpertOpinionVerificationResponse, FrmExpertOpinionQuestionnaireResponse, FrmExpertOpinionDataEntryResponse, FrmExpertOpinionExternalVerificationResponse, DropDownItem } from "../@types/frmExpertOpinionRequest";
...
const FK_Task02: FC<FK_Task02Props> = (props) => {
  ...
  const steps = [{
    ...
    content: <FrmExpertOpinionForm task={task} frmExpertOpinion={frmExpertOpinion} frmInvestigation={frmInvestigation} expertOpinionStatus={true} frmexpertUsers={frmexpertUsers} monthList={monthList} />
  },
  {
    label: "Action Points",
