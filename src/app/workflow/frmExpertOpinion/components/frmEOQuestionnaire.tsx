...
import { FrmExpertOpinionQuestionnaireResponse } from "../@types/frmExpertOpinionRequest";


export interface FrmEOQuestionnaireFormProps {
    frmQuestionnaire: FrmExpertOpinionQuestionnaireResponse[] | null
}
    ...
    return (
        <Paper className="px-12">
            ...
            <form noValidate>
                ...
                >
                    {frmQuestionnaire?.map((completedData, index) => {
