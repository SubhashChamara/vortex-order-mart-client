...
import { SaveDocRetainedRequest } from "../@types/SaveDocRetainedRequest";
...
import { documentDetailSchema } from "../schema/Schema";
...
const OverDraftFlow: React.FC<OverDraftFlowProps> = ({ task }) => {
  const methods = useForm<FormType>({
    ...
    resolver: zodResolver(documentDetailSchema),
  });
          ...
          <div className="flex flex-col gap-9">
            <div className="grid grid-cols-2 gap-14">
              <div className="flex flex-col gap-14">
                ...
                <DocumentDetailForm editable={true} />
              </div>
              <AttachmentsForm
                documentList={documentList}
                selectedDocument={selectedDocument}
