...
import CribFileUpload from "../components/CribFileUpload/CribFileUpload";
  ...
  return (
    <FormProvider {...methods}>
      ...
      <div className="flex flex-col gap-12">
        <Ve3StepWizard
          selectStep={steps.findIndex((step) => step.label === "Crib Upload")}
          currentSteps={[
            steps.findIndex((step) => step.label === "Crib Upload"),
          ]}
          completedSteps={Array.from({ length: steps.length - 1 }, (_, i) => i)}
          steps={steps}
        />
      </div>
    </FormProvider>
