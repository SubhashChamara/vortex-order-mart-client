...
const BundleForm: React.FC<BundledFlowProps> = ({ task }) => {
  ...
  const steps = [
    ...
    ...(isCC && task.taskId !== "checkAndVerifyInformationLoan"
      ? [
          {
    ...
    ...(isAlpl && task.taskId !== "checkAndVerifyInformationCard"
      ? [
          {
    ...
    },
    {
      ...
      content: (
        <form onSubmit={handleSubmit(handleCellUserChecklistSubmission)}>
          <CellUserCheckList
            editable={true}
