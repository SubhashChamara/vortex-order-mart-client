...
interface ExcelDataViewPLLGProps {
  data: CribPullPLLoanInfo | null;
}

const ExcelDataViewPLLG: React.FC<ExcelDataViewPLLGProps> = ({ data }) => {
  return (
    <div>
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>{data.preferredBranch || ""}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell style={{ fontWeight: "bold" }}>
                  MONTHLY INCOME
              ...
              <TableRow>
                <TableCell style={{ fontWeight: "bold" }}>MARRIED</TableCell>
                <TableCell>{data.married || ""}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell style={{ fontWeight: "bold" }}>
                  EMPLOYER NAME
              ...
              <TableRow>
                ...
                <TableCell>{data.experienceInYears || ""}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell style={{ fontWeight: "bold" }}>
                  DESIRED LOAN AMOUNT
                </TableCell>
                <TableCell>{data.desiredLoanAmount || ""}</TableCell>
              </TableRow>
              <TableRow>
...
export default ExcelDataViewPLLG;
