  ...
  const onSubmit = async (formData: FormType) => {
    ...
    const body: CribPullProcess[] = tableData.cribPullProcessList.map(
      (process, index) => ({
        ...
        clientEmail: process.clientEmail || null,
  ...
  const handleXMLFileUpload = async () => {
    try {
      ...
      if (xmlUploadData !== null) {
        ...
        toast.error(xmlUploadError?.msg);
      }
    } catch (err) {
      console.log(err);
    } finally {
      ...
      <Paper className="px-12 pb-12 flex flex-col gap-12">
        ...
        <div className="relative">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex justify-end my-6 gap-12 h-full items-end pt-9">
              <div className="flex flex-row justify-between w-full items-center">
                <Alert severity="info">
                  Please save the form initially and download the text file
                </Alert>
                <div className="flex flex-row gap-12">
                  <div className="flex flex-row gap-9 items-center">
                    {chosenFile && (
                      <Tooltip title={`Remove file - ${chosenFile.name}}`}>
                        <EdgeSvgIcon
                    ...
                    <Button
                      ...
                      disabled={chosenFile ? true : false}
                      sx={{
                    ...
                    >
                      <EdgeSvgIcon size={20} className="pr-3">
                  ...
                  <Button aria-label="Save" type="submit">
                    <EdgeSvgIcon
                      ...
                      color="error"
                    >
                      {!isTextFileDownloading && "feather:download"}
                    </EdgeSvgIcon>
                    Save & Download Text File
                  </Button>
                </div>
              </div>
            </div>
