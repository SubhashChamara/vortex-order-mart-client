...
import { FrmQExpertOpinionResponse, FrmQExternalVerificationResponse } from "../@types/FrmQuestionnaireResponse";




export interface FrmEQVerificationFormProps {
    frmExternalVerification: FrmQExternalVerificationResponse[] | null
}
...
const FrmEQExternalVerificationForm: FC<FrmEQVerificationFormProps> = (props) => {
...
export default FrmEQExternalVerificationForm;