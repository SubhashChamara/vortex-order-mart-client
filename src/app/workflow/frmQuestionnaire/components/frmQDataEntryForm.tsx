...
import { FrmQDataEntryResponse } from "../@types/FrmQuestionnaireResponse";


type FrmQDataEntryFormProps = {
    dataEntry: FrmQDataEntryResponse | null;
...
const FrmQDataEntryForm: FC<FrmQDataEntryFormProps> = (props) => {
...
export default FrmQDataEntryForm;
