...
import { FrmQVerificationResponse } from "../@types/FrmQuestionnaireResponse";

type FrmVerificationProps = {
    frmVerification: FrmQVerificationResponse[] | null
}
...
const FrmQVerificationForm: FC<FrmVerificationProps> = (props) => {
...
export default FrmQVerificationForm;