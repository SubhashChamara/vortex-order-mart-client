...
import { FrmQActionPointResponse } from "../@types/FrmQuestionnaireResponse";

type FrmActionPointProps = {
  frmActionPoint : FrmQActionPointResponse [] | null
  };
  
  const FrmQActionPointForm: FC<FrmActionPointProps> = (props) => {
        ...
        <div className="col-span-2">
          <TableContainer component={Paper} className="max-w-screen-md">
            <Table className="max-w-screen-md">
              ...
              <TableBody>
                {frmActionPoint?.map((actionPoint) => (
                  <TableRow>
  ...
  export default FrmQActionPointForm;