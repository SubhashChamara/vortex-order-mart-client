...
const UserForm: FC<UserFormProps> = (props) => {
  ...
  // Similarly, define other fetch methods
  ...
  useEffect(() => {
    const loadData = async () => {
      if (cliProcessData !== null) {
        try {
          // Await the completion of fetchMasterData
          // await Promise.all([
          //   fetchPersonalTitleMasterData(),
          //   fetchCardTypeMasterData(),
          //   // fetchUpgradeCardTypeMasterData(),
          ...
          // Ensure lists are not empty and have required items
          ...
          // )!;
          // const enhancement = enhancementTypeList.find(
          //   (item) => item.name === cliProcessData.enhancementType
          // )!;
          // const upgradeTo = cliProcessData.isUpgradeRequired
          //   ? cardTypeList.find(
          //       (item) => item.name === cliProcessData.upgradeTo
          //     ) || null
          //   : null;
          // const modeType = requestModesList.find(
          //   (item) => item.name === cliProcessData.modeType
          // )!;

          // Set form values
          setValue("oldNicNumber", cliProcessData.oldNicNumber);
      ...
      <Paper className="px-12">
        ...
        >
          ...
          <Controller
            ...
            render={({ field }) => (
              <FormControlLabel
                control={<Checkbox {...field} checked={field.value} disabled />}
                label="Crib Justification Attached"
              />
            )}
          />
