          ...
          >
            <div className="flex flex-col items-center justify-center py-6">
              ...
              <p className="mb-3 text-sm text-gray-500 ">
                <span className="font-semibold">Click to upload File 1</span>
              </p>
              <p className="text-xs text-gray-500 ">
                {file1 !== null ? file1.name : "JPG, PDF, WORD (MAX. 2 MB)"}
              </p>
            </div>
            <input
              id="attach-file1"
        ...
        <div className="flex items-center justify-center w-full">
          ...
          >
            <div className="flex flex-col items-center justify-center py-6">
              ...
              <p className="mb-3 text-sm text-gray-500 ">
                <span className="font-semibold">Click to upload File 2</span>
              </p>
              <p className="text-xs text-gray-500 ">
                {file2 !== null ? file2.name : "JPG, PDF, WORD (MAX. 2 MB)"}
              </p>
            </div>
            <input
              id="attach-file2"
