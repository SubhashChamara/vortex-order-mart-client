...
type FrmExpertOpinionCompletedProps = {
  expertOpinions: FrmExpertOpinionResponse[] | null;
...
const FrmExpertOpinionForm: FC<FrmExpertOpinionCompletedProps> = (props) => {
    const { expertOpinions,frmexpertUsers } = props;
            ...
            <form noValidate>
                ...
                >
                    <div style={{ maxHeight: '400px', overflowY: 'auto', padding: '10px' }}>
                        {expertOpinions?.map((record, index) => (
