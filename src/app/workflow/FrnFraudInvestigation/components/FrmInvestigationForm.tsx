...
const FrmInvstForm: FC<FrmInvestProps> = (props) => {
  ...
  useEffect(() => {
    if (form !== null) {
      ...
      setValue("oldNic", form.nicOld);
      setValue("newNic", form.nicNew);
      setValue("monthVal", form.monthVal);
      setValue("year", form.accOpenYearVal);
      setValue("groupAccNo", form.groupAccountNo);
      setValue("ecapsRef", form.ecapsRef);
      setValue("bucket", form.bucket);
      setValue("comment", form.comment);
      setValue("makerComment", form.commentMaker);
...
<Controller
            ...
            render={({ field: { onChange } }) => (
              <Autocomplete
                ...
                value={gettitleList.find((option) => option.id === form?.monthVal) || null}
                ...
                renderInput={(params) => (
                  <TextField
                    ...
                    label="Month"
                    size="small"
                    error={!!errors.monthVal}
                    helperText={errors?.monthVal?.message}
                    InputLabelProps={{
                      shrink: true,
                    }}
                  />
