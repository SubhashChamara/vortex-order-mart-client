...
const FK_Task01: FC<FK_Task01Props> = (props) => {
  ...
  const steps = [
    ...
    {
      label: "FRM Expert Opinions",
      content: <FrmExpertOpinionForm expertOpinions={expertOpinions} />, // Render expert opinions
    },
    {
      label: "FRM Verification Flow",
      content: <FrmVerificationFlow verificationData={verifications || []} />,
    },
    {
      label: "FRM External Verification Flow",
      content: <FrmExternalVerificationForm externalVerifications={externalVeri || []} />,
    },
    {
      label: "FRM Questionnaire Flow",
  ...
  useEffect(() => {
    ...
    [form, actionPoints, expertOpinions, verifications, dataentry, externalVeri,getData])
