...
const EFormView: React.FC<EFormViewProps> = ({
  editable,
  onUploadButtonClick,
}) => {
  ...
  return (
    <div>
      <Paper className="px-12 pb-10 h-full">
        <Ve3FormHeader icon="feather:file-text" title="E Form" />
        <div className="flex flex-col gap-9">
                ...
                >
                  ...
                  {!field.value ? (
                    <div className="flex flex-col items-center justify-center py-6">
                      ...
                      <p className="text-xs text-gray-500">PDF (MAX. 2 MB)</p>
                    </div>
                  ) : (
          ...
          <div className="flex gap-9 justify-end">
            <Button aria-label="Save" type="button" disabled={!editable}>
              <EdgeSvgIcon
